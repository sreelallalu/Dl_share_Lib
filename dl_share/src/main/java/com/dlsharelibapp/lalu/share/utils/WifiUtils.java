...
public class WifiUtils {
    ...
    public static boolean isWifiConnectedToSTAccessPoint(Context context) {
      ...
      //  isShareThemSSID(((WifiManager) context.getApplicationContext().getSystemService(Context.WIFI_SERVICE)).getConnectionInfo().getSSID());
    ...
    public static boolean isShareThemSSID(String ssid) {
        ...
        // TODO: 12/3/18 wifi connecting to specific network
        ...
        try {
            ...
            if(splits!=null&&splits.length>1) {
                     ...
                     return names[0] != null ? names[0].equalsIgnoreCase(Contants.SENDER_BASE) : false;
    ...
    public static int getSenderSocketPortFromSSID(String ssid) {
        ...
        if (splits.length != 2)
            return -1;
        String[] names = new String(Base64.decode(splits[1], Base64.DEFAULT)).split("\\|");
        if ( names[0].equalsIgnoreCase(Contants.SENDER_BASE))
    ...
    public static String[] getSenderInfoFromSSID(String ssid) {
        ...
        String[] splits = ssid.split("-");
            ...
            return new String[]{Contants.SENDER, ""+Contants.PORT};
