...
import static com.dlsharelibapp.lalu.share.receiver.ReceiverActivity.WifiTasksHandler.SCAN_FOR_WIFI_RESULTS;
import static com.dlsharelibapp.lalu.share.receiver.ReceiverActivity.WifiTasksHandler.WAIT_FOR_CONNECT_ACTION_TIMEOUT;
import static com.dlsharelibapp.lalu.share.receiver.ReceiverActivity.WifiTasksHandler.WAIT_FOR_RECONNECT_ACTION_TIMEOUT;
import static com.dlsharelibapp.lalu.share.utils.WifiUtils.connectToOpenHotspot;
...
public class ReceiverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.p_p_receiver);
    ...
    public void onResume() {
       ...
       //Log.e("bool",isConnectedToShareThemAp+"");
        ...
        if (isConnectedToShareThemAp) {
            ...
            Log.d(TAG, "wifi is connected/connecting to Lalism send, ssid: " + ssid);
            mConnectedSSID = ssid;
