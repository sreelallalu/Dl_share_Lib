...
public class HotspotControls {
    ...
    private static HotspotControls instance = null;
    ...
    private HotspotControls(Context context) {
        wm = (WifiManager) context.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        deviceName = WifiUtils.getDeviceName(wm);
    }

    public static HotspotControls getInstance(Context context) {
        if (instance == null) {
            instance = new HotspotControls(context);
        }
        return instance;
    }
