...
import static com.dlsharelibapp.lalu.share.sender.ShareService.ShareIntents.SHARE_CLIENT_IP;
import static com.dlsharelibapp.lalu.share.sender.ShareService.ShareIntents.SHARE_SERVER_UPDATES_INTENT_ACTION;
import static com.dlsharelibapp.lalu.share.sender.ShareService.ShareIntents.SHARE_SERVER_UPDATE_FILE_NAME;
import static com.dlsharelibapp.lalu.share.sender.ShareService.ShareIntents.SHARE_SERVER_UPDATE_TEXT;
import static com.dlsharelibapp.lalu.share.sender.ShareService.ShareIntents.SHARE_TRANSFER_PROGRESS;
import static com.dlsharelibapp.lalu.share.sender.ShareService.ShareIntents.TYPE;
import static com.dlsharelibapp.lalu.share.sender.ShareService.ShareIntents.Types.AP_DISABLED_ACKNOWLEDGEMENT;
import static com.dlsharelibapp.lalu.share.sender.ShareService.ShareIntents.Types.FILE_TRANSFER_STATUS;
...
public class ShareService extends Service {
    ...
    private ShareServer m_fileServer;
...
//                    sendAcknowledgementBroadcast(AP_ENABLED_ACKNOWLEDGEMENT);
     ...
     * @param addStopAction if true STOP action is added to stop {@link ShareService}
     * @return Notification
     */
    private Notification getShareThemNotification(String text, boolean addStopAction) {
        ...
        builder.setContentIntent(pendingIntent)
                .setSmallIcon(android.R.drawable.btn_minus).setWhen(System.currentTimeMillis())
    ...
    private void startFileHostingServer(String[] filePathsTobeServed, int port, final String sender_name) {
        ...
        m_fileServer = new ShareServer(getApplicationContext()
                , new FileListener() {
            @Override
